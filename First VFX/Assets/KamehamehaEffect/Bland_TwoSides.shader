...
Shader "Bland_TwoSides"
{
	Properties
	{
		...
		_BackFacesColor("Back Faces Color", Color) = (0,0,0,0)
		[Toggle(_KEYWORD0_ON)] _Keyword0("Keyword 0", Float) = 0
		_FresnalColor("Fresnal Color", Color) = (0,0,0,0)
		_FrontFacesColor("Front Faces Color", Color) = (0,0,0,0)
		[Toggle(_KEYWORD1_ON)] _Keyword1("Keyword 1", Float) = 1
		_Fresnel("Fresnel", Float) = 1
		[ASEEnd]_Float1("Float 1", Float) = 2
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float fresnelNode39 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV39, _Fresnel ) );
				#ifdef _KEYWORD1_ON
				float4 staticSwitch30 = ( ( _FrontFacesColor * ( 1.0 - fresnelNode39 ) ) + ( _Float1 * _FresnalColor * fresnelNode39 ) );
				#else
				float4 staticSwitch30 = _FrontFacesColor;
				#endif
				float4 lerpResult15 = lerp( staticSwitch30 , _BackFacesColor , float4( 0,0,0,0 ));
				...
				float2 appendResult20 = (float2(_SpeedMainTexUVnoise.z , _SpeedMainTexUVnoise.w));
				#ifdef _KEYWORD0_ON
				float staticSwitch26 = uvs4_Noise.z;
				#else
				...
				float3 Color = ( lerpResult15 * 2.0 * IN.ase_color * tex2D( _MainTex, ( float4( uv_MainTex, 0.0 , 0.0 ) + ( appendResult19 * ( _TimeParameters.x ) ) ).xy ) * IN.ase_color.a ).rgb;
				float Alpha = 1;
				float AlphaClipThreshold = ( tex2D( _Mask, uv_Mask ) * tex2D( _Noise, ( (uvs4_Noise).xyzw + float4( ( ( _TimeParameters.x ) * appendResult20 ), 0.0 , 0.0 ) ).xy ) * staticSwitch26 ).r;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.AlphaClipThreshold = ( tex2D( _Mask, uv_Mask ) * tex2D( _Noise, ( (uvs4_Noise).xyzw + float4( ( ( _TimeParameters.x ) * appendResult20 ), 0.0 , 0.0 ) ).xy ) * staticSwitch26 ).r;
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;2652.354;896.8931;1.479723;True;True
Node;AmplifyShaderEditor.Vector4Node;16;-1812.5,303.0615;Inherit;False;Property;_SpeedMainTexUVnoise;Speed MainTex U/V + noise;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;22;-1280.677,338.8263;Inherit;False;0;10;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TimeNode;21;-1513.677,358.8263;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;20;-1491.677,518.8262;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-1271.249,526.3864;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;23;-1047.677,376.8263;Inherit;False;True;True;True;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-813.9782,533.6266;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;8;-860.3196,446.9562;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;26;-691.5773,565.7262;Inherit;False;Property;_Keyword0;Keyword 0;6;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;10;-703.5043,338.7032;Inherit;True;Property;_Noise;Noise;1;0;Create;True;0;0;0;False;0;False;-1;None;b254f331987da15448154623de5a782d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;12;-680.2925,-53.35233;Inherit;True;Property;_MainTex;Main Tex;3;0;Create;True;0;0;0;False;0;False;-1;None;a692d53d3c9f42143a54b9c204fd6f69;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;30;-877.9705,-433.6943;Inherit;False;Property;_Keyword1;Keyword 1;9;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-1815.345,-178.0815;Inherit;False;Property;_Fresnel;Fresnel;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;38;-1424.857,-607.1761;Inherit;False;Property;_FrontFacesColor;Front Faces Color;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;24;-1129.677,106.8263;Inherit;False;0;12;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-1575.857,-473.1761;Inherit;False;Property;_Float1;Float 1;11;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;36;-1643.857,-398.1761;Inherit;False;Property;_FresnalColor;Fresnal Color;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;29;-893.9705,-320.6943;Inherit;False;Property;_BackFacesColor;Back Faces Color;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;44;4;2;0
ASEEND*/
//CHKSM=A53DEADE517C7A8ABD03A58E94B28FFBC3F71301